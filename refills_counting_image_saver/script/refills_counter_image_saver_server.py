...
def save_image_server():
    #deleting the directory and make them again empty
    shutil.rmtree('/home/refills/workspace/rs_ws/src/refills_counting_image_saver/refills_counting_pictures/')
    os.makedirs('/home/refills/workspace/rs_ws/src/refills_counting_image_saver/refills_counting_pictures/')
